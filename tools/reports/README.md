...
- **~07:00 JST** — the `daily-status-line.yml` GitHub Action *reads* this file (plus the live
  open-`inbox` issue count) and messages the maintainer via LINE — but only if something changed
