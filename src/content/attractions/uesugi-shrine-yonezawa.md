---
title: "Uesugi Shrine & Yonezawa Beef"
summary: "A dignified shrine on the moated site of Yonezawa Castle, honoring the warlord Uesugi Kenshin — and the gateway to one of Japan's three great wagyu brands, Yonezawa beef, grilled and sizzling all over town."
prefecture: yamagata
city: "Yonezawa"
...
lng: 140.1050
category: history
tags: [shrine, history, samurai, food, wagyu, kids, family-friendly]
seasons: []
months: []
seasonNote: "Year-round; cherry blossoms ring the castle moat in late April, and a samurai festival fills the streets in early May."
difficulty: easy
timeRequired: half-day
cost:
  type: free
  note: "Free to visit the shrine and park; the museum and, of course, the beef cost extra."
parking:
  available: yes
  note: "Parking around the castle park."
transit:
  nearestStation: "Yonezawa Station + bus"
  note: "Bus or taxi from Yonezawa Station to the Matsugasaki (castle) park."
accessibility:
  wheelchair: partial
  note: "Flat park paths; the shrine has a few steps."
dogFriendly: limited
heroImage: "/images/attractions/uesugi-shrine-yonezawa.svg"
photos:
  - src: "/images/attractions/uesugi-shrine-yonezawa-1.svg"
    alt: "A traditional shrine with a stone torii beside a plate of marbled Yonezawa beef"
    caption: "A samurai-clan shrine — and the gateway to legendary Yonezawa beef."
  - src: "/images/attractions/uesugi-shrine-yonezawa-2.svg"
    alt: "Mon-chan and Cinnamon the squirrel at a shrine torii near grilling Yonezawa beef"
    caption: "Prayed at the shrine, then smelled the beef. Cinnamon abandoned prayer immediately."
website: "https://www.uesugi-jinja.or.jp/"
tips:
  - "The shrine sits in the moated park where Yonezawa Castle once stood — walk the grounds."
  - "Yonezawa beef is the local headline — try it as steak, sukiyaki, or a humble beef bowl."
  - "Time a spring visit to the early-May Uesugi Festival, with a costumed warrior procession."
status: open
approval: published
source: ai-agent
...
confidence: 0.82
sources:
  - title: "Uesugi Shrine — Wikipedia"
    url: "https://en.wikipedia.org/wiki/Uesugi_Shrine"
aiSummary: "Uesugi Shrine in Yonezawa, Yamagata, stands on the former Yonezawa Castle grounds honoring Uesugi Kenshin, and the city is famous for Yonezawa beef, a premier wagyu brand."
aiKeywords: [uesugi shrine, yonezawa, yonezawa beef, wagyu, uesugi kenshin, yamagata]
related:
  - utsunomiya-gyoza
