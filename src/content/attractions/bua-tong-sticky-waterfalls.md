...
summary: "A waterfall you climb UP, barefoot, with no ropes: the mineral limestone is so grippy your feet stick to it even under flowing water — one of the strangest physical sensations in Thailand, and completely free."
country: thailand
prefecture: chiang-mai
city: "Mae Taeng"
address: "Bua Thong Waterfalls, Mae Ho Phra, Mae Taeng, Chiang Mai"
lat: 19.15
lng: 99.05
category: nature
tags: [nature, experience, oddity, outdoor, kids, family-friendly, free, hidden-gem, weird]
seasons: []
months: []
difficulty: moderate
...
parking:
  available: yes
  note: "Free parking at the falls (Si Lanna National Park area)."
transit:
  nearestStation: "No transit — about 60km / 1.5 hours north of Chiang Mai by car or scooter"
accessibility:
  wheelchair: no
dogFriendly: unknown
tips:
  - "The trick is real geology: the spring water is loaded with calcium carbonate, which coats the rock in porous, sandpaper-textured travertine — bare feet grip it even mid-cascade. Only the algae-darkened patches are slippery; stay on the white rock."
  - "Start at the bottom (stairs lead down) and climb the three tiers back up through the water — there are knotted ropes on the steepest section, but most people never need them."
...
confidence: 0.83
sources:
  - title: "Bua Thong Waterfalls — Tourism Authority of Thailand"
    url: "https://www.tourismthailand.org/Attraction/bua-tong-waterfall"
aiSummary: "Travertine waterfalls in Mae Taeng, north of Chiang Mai, whose calcium-carbonate-coated limestone is grippy enough to climb barefoot against the flow; free entry within the Si Lanna National Park area."
