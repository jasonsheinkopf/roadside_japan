...
summary: "A castle town an hour from Tokyo that still looks like the Edo period: a street of black-walled clay merchant warehouses crowned by a wooden bell tower that has rung the hours for centuries."
prefecture: saitama
city: "Kawagoe"
address: "Saiwaicho, Kawagoe, Saitama"
lat: 35.9255
lng: 139.4855
category: history
tags: [history, nostalgic, architecture, food, photography, family-friendly]
seasons: []
months: []
seasonNote: "Pleasant year-round; the October Kawagoe Festival brings huge wooden floats."
difficulty: easy
timeRequired: half-day
cost:
  type: free
  note: "Free to wander; museums, snacks, and rickshaws cost extra."
parking:
  available: limited
  note: "Paid lots fill on weekends; the train is easier."
transit:
  nearestStation: "Kawagoe Station / Hon-Kawagoe Station"
  note: "Direct trains from Ikebukuro and Shinjuku; then a bus or 15-minute walk to the old street."
accessibility:
  wheelchair: partial
...
tips:
  ...
  - "Kawagoe is sweet-potato country: try imo snacks, chips, and soft-serve along Kashiya Yokocho candy alley."
  - "Go on a weekday; the warehouse street gets very busy on weekends."
status: open
approval: published
source: ai-agent
...
confidence: 0.84
sources:
  - title: "Kawagoe — Wikipedia"
    url: "https://en.wikipedia.org/wiki/Kawagoe,_Saitama"
aiSummary: "A historic former castle town in Saitama nicknamed Little Edo, preserving a street of kurazukuri clay warehouses, the Toki no Kane bell tower, and a candy alley."
aiKeywords: [kawagoe, little edo, koedo, kurazukuri, toki no kane, saitama]
related:
  - nihon-minkaen
...
cinnamon:
  ...
  emoji: "🏮"
  report: |-
    Kawagoe is an hour from Tokyo and about 160 years away: a street of black-walled clay merchant warehouses under heavy tiled roofs, crowned by a wooden bell tower that has rung the hours for centuries — and still does, four times a day.
