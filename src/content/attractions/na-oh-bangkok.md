---
title: Na Oh (Dining Inside a Grounded Airplane)
summary: A high-concept restaurant built inside a decommissioned airliner at the Chang Chui creative park — a moody, post-apocalyptic 'survival' dining room where a set menu is served amid the salvaged fuselage.
prefecture: bangkok
city: Bangkok
address: Chang Chui, Sirindhorn Rd, Bang Phlat, Bangkok
lat: 13.782
lng: 100.476
category: experience
tags:
...
cost:
  type: paid
  note: A set-menu concept restaurant; reservations recommended. Confirm it's operating before a special trip.
status: unknown
approval: published
source: imported
sources:
