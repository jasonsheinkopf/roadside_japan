---
title: Phra Nang Princess Cave
summary: A seaside grotto on a stunning Krabi beach crammed with hundreds of carved and painted wooden phalluses — offerings to a sea princess spirit from fishermen seeking safe passage and a good catch.
prefecture: krabi
city: Ao Nang
address: Phra Nang Beach, Railay, Mueang Krabi District, Krabi
lat: 8.0073
lng: 98.838
category: oddity
heroImage: https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Phra_Nang_cave_P1120058.JPG/960px-Phra_Nang_cave_P1120058.JPG
photos:
  - src: https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Phra_Nang_cave_P1120058.JPG/960px-Phra_Nang_cave_P1120058.JPG
    alt: The Phra Nang Princess Cave shrine on Railay, Krabi
    credit: Photo via Wikimedia Commons
    creditUrl: https://commons.wikimedia.org/wiki/File:Phra_Nang_cave_P1120058.JPG
tags:
  - oddity
  - beach
  - religious
...
seasons: []
months: []
seasonNote: Reachable year-round by boat; calmer seas and clearer skies in the cool season (Nov–Mar) make the crossing easier.
difficulty: easy
timeRequired: one-hour
cost:
  type: free
  note: Free; you'll pay only for the longtail boat to Railay.
parking:
  available: no
  note: Railay has no road access — there is nowhere to park; arrive by boat.
transit:
  nearestStation: Krabi town/Ao Nang — longtail boat to Railay (no roads in)
  note: Take a longtail boat from Ao Nang or Krabi's Ao Nammao pier; the cave is at the end of Phra Nang Beach.
accessibility:
  wheelchair: no
  note: Beach access only, reached by wading from a longtail boat onto sand.
dogFriendly: limited
tips:
  - Combine it with a swim at Phra Nang Beach, regularly rated among Thailand's most beautiful.
  - Be respectful — this is a genuine, actively used shrine, not just a curiosity.
  - Boats from Ao Nang are cheapest when shared; agree the fare before stepping in.
status: open
approval: published
source: imported
