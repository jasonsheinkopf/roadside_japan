...
summary: For three days every April, the whole country turns into the world's biggest water fight — Thai New Year, where soaking strangers with buckets and hoses is both a blessing and a national pastime.
prefecture: bangkok
city: Bangkok
address: Citywide — Khao San Rd & Silom are the epicentres in Bangkok
lat: 13.7563
lng: 100.5018
category: festival
tags:
...
months:
  - 4
seasonNote: Officially 13–15 April nationwide; some cities (e.g. Chiang Mai) stretch it longer.
difficulty: easy
timeRequired: full-day
cost:
  type: free
  note: Free; budget for a water gun and a waterproof phone pouch.
parking:
  available: limited
  note: Avoid driving — roads close and you'll get soaked at every junction anyway.
transit:
  nearestStation: BTS/MRT across Bangkok; Silom and Khao San are the hot spots
  note: Use the Skytrain/metro — far easier than the gridlocked, water-soaked streets.
accessibility:
  wheelchair: partial
  note: Streets are flat but chaotic, slippery, and extremely crowded.
dogFriendly: no
tips:
  - Everything you carry will get wet — seal your phone and cash in a waterproof pouch.
  - "The traditional heart of it is gentler: pouring scented water over Buddha images and elders' hands for blessings."
