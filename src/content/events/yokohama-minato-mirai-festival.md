---
title: "Yokohama Minato Mirai Festival (GREEN×EXPO 2027 Fireworks)"
summary: "A one-night waterfront festival at Yokohama's Minato Mirai promoting the upcoming GREEN×EXPO 2027, combining live music and street performers with a large-scale fireworks finale over the harbor."
prefecture: kanagawa
city: "Yokohama"
address: "Rinko Park, 1-1 Minatomirai, Nishi, Yokohama, Kanagawa"
lat: 35.4547
lng: 139.6389
category: festival
tags: [festival, fireworks, night, free, outdoor, photography]
seasons: [summer]
months: [8]
...
cost:
  type: varies
  note: "Some viewing areas are free (first-come); designated paid viewing areas are also available."
parking:
  available: no
transit:
  nearestStation: "Minato Mirai Station (Minato Mirai Line) — 5 min walk to Rinko Park"
  note: "Sakuragicho Station (JR / subway) is about 12 min walk."
accessibility:
  wheelchair: yes
  note: "Waterfront promenades are flat and paved, though extremely crowded during the fireworks."
dogFriendly: no
tips:
...
confidence: 0.78
sources:
  - title: "Minato Mirai Festival in Support of GREEN×EXPO 2027 — Yokohama Official Visitors Guide"
    url: "https://www.yokohamajapan.com/events/detail.php?id=287"
  - title: "A Major Fireworks Festival Is Coming to Yokohama Minato Mirai on August 24, 2026"
    url: "https://yokohama-minatomirai.com/en/minatomirai-fireworks-2026-august24-en/"
...
cinnamon:
  ...
  snapshots:
    - cast: [cinnamon]
      prop: "🎆"
      caption: "Container-crane shoulder seats with the seagulls, who critique fireworks nightly and awarded this finale their highest honor: silence."
    - cast: [cinnamon, socks]
      prop: "🎡"
      caption: "The harbor handing the light back doubled — Ferris wheel, sail hotel, bay. Expo warm-up events run their own calendars; check dates rather than assume repeats."
---
...
Rather than a standard hanabi night, this is billed as a full festival — live music and street performers along the harbor promenade building toward a large-scale fireworks finale over Yokohama Bay. It's tied specifically to raising awareness for GREEN×EXPO 2027, the international horticultural exposition Yokohama will host the following year, which makes this a one-time-feeling event rather than a fixture you can count on repeating annually in the same form.

## Best Time to Visit

The single date is Saturday, August 24, 2026, with the festival building through the evening to a fireworks finale.

## Getting There

Five minutes on foot from Minato Mirai Station to Rinko Park, or about twelve minutes from Sakuragicho Station; expect heavy crowds along the whole waterfront that evening.
